...
import pt.ipp.isep.dei.esoft.project.lab.two.problem.three.version.two.ProblemThreeSolution;
...
class ProblemThreeSolutionTest {
    ...
    public void ensureSortingAllNullArraysReturnsNull() {
        // Act
        boolean result = ProblemThreeSolution.sortStudentsByAscendingNumber(null, null, null);
    ...
    public void ensureSortingNullNumbersArrayReturnsFalse() {
        ...
        // Act
        boolean result =
                ProblemThreeSolution.sortStudentsByAscendingNumber(studentNumbers, studentNames, studentGrades);
